            ...
            (function () {
                      ...
                      t.forEach((t) => {
                        (Array.isArray(t.select)
                          ...
                          t.render && (r.render = t.render),
                            ...
                            void 0 !== t.isSplitQueryWord &&
                              (r.isSplitQueryWord = t.isSplitQueryWord),
                            void 0 !== t.searchQuerySeparator &&
                              (r.searchQuerySeparator = t.searchQuerySeparator);
                        });
                      }),
                      (i = i.map(
                        (t) =>
              ...
              const z = {
                ...
                J = (t, e, s, i, n) => {
                  let a = [];
                  if (
                    (n.firstLast && a.push(U(1, n.firstText, n)), n.nextPrev)
                  ) {
                    const e = t ? 1 : s - 1;
                    a.push(U(e, n.prevText, n, { hidden: t }));
                  }
                  let o = [...Array(i).keys()].map((t) =>
                    U(t + 1, String(t + 1), n, { active: t === s - 1 })
                  );
                  if (
                    (n.truncatePager &&
                      (o = ((t, e, s, i) => {
              ...
              (exports.DataTable = class {
                constructor(t, e = {}) {
                  ...
                  const i = { ...z.diffDomOptions, ...e.diffDomOptions },
                    n = { ...z.labels, ...e.labels },
                  ...
                  (this.options = {
                    ...
                    (this._dd = new k(this.options.diffDomOptions || {})),
                    (this.initialized = !1),
                    (this._events = {}),
                    (this._currentPage = 0),
                    (this.onFirstPage = !0),
                ...
                init() {
                  ...
                  (this._virtualDOM = M(
                    ...
                    (this.rows = new F(this)),
                    (this.columns = new Q(this)),
                    (this.data = W(
                      this.options.data,
                      this.dom,
                  ...
                  this.data.data.forEach((t, s) => {
                    ...
                    e.every((t) =>
                      t.find(
                        (t, e) =>
                          !!t &&
                          (this.columns.settings[e].isSplitQueryWord
                            ? t.split(
                                this.columns.settings[e].searchQuerySeparator
                              )
                            : [t]
                          ).find((t) => i[e].includes(t.trim()))
                      )
